...
FORM CHECK_DATA .
  ...
  IF GS_HEADER IS NOT INITIAL AND GT_ITEM IS NOT INITIAL.
    ...
    PERFORM SET_SAVE_PATH CHANGING LV_SAVEPATH.   " 저장 경로 설정

    PERFORM SAVE_TEMPLATE USING LV_SAVEPATH.      " SMW0에서 템플릿 가져오기

    PERFORM SET_EXCEL_DATA USING LV_SAVEPATH.
...
FORM SET_HEADER_CELLS .
  ...
  PERFORM SET_HEADER USING 6 5 GS_HEADER-ADDRESS.  " 회사 주소
