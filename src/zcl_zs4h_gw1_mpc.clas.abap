class ZCL_ZS4H_GW1_MPC definition
  public
...
CLASS ZCL_ZS4H_GW1_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZS4H_GW1_SRV' ).
...
lo_ref_constraint->add_property( iv_principal_property = 'PoNumber'   iv_dependent_property = 'PoItem' ). "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'POItemSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'POITEMSET' "#EC NOTEXT
                                                              iv_association_name = 'PO_Association' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIMEPOHEADER'
...
lo_property->set_unit_property( 'PoUnit' ).  "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_property->set_unit_property( 'PriceUnit' ).  "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPIMEPOITEM'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250925015726'.                  "#EC NOTEXT
